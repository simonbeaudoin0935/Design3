...
QT_MOC_LITERAL(1, 7, 18), // "cameraDisconnected"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Camera\0cameraDisconnected\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cameraDisconnected(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Camera::cameraDisconnected)) {
                *result = 0;
                return;
            }
        }
