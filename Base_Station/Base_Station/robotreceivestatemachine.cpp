...
bool RobotReceiveStateMachine::parseMessage(char p_byteToParse)
{
...
unsigned char RobotReceiveStateMachine::getMessageId()
{
    return m_messageId;
}

QByteArray RobotReceiveStateMachine::getMessageContent()
{
    return m_messageContent;
}

void RobotReceiveStateMachine::resetMessageParserStateMachine()
{
    m_state = WAIT_START_CHARACTER;
...
float RobotReceiveStateMachine::readFloatUnion(QByteArray::iterator& p_it)
{
...
int RobotReceiveStateMachine::readIntUnion(QByteArray::iterator& p_it)
{
