...

{
    ...
    QObject::connect(m_robotManager,
                     ...
                     this,
                     SLOT(PIDValuesReceived(PIDValuesStruct)));
...
void MainWindow::PIDValuesReceived(PIDValuesStruct pid)
{
    ui->doubleSpinBox_Position_X_PKp->setValue((double) pid.position_X_PKp);
    ui->doubleSpinBox_Position_X_PKi->setValue((double) pid.position_X_PKi);
    ui->doubleSpinBox_Position_X_PKd->setValue((double) pid.position_X_PKd);
    ui->doubleSpinBox_Position_X_Vmax->setValue((double) pid.position_X_Vmax);
    ui->doubleSpinBox_Position_X_Amax->setValue((double) pid.position_X_Amax);

    ui->doubleSpinBox_Position_Y_PKp->setValue((double) pid.position_Y_PKp);
    ui->doubleSpinBox_Position_Y_PKi->setValue((double) pid.position_Y_PKi);
    ui->doubleSpinBox_Position_Y_PKd->setValue((double) pid.position_Y_PKd);
    ui->doubleSpinBox_Position_Y_Vmax->setValue((double) pid.position_Y_Vmax);
    ui->doubleSpinBox_Position_Y_Amax->setValue((double) pid.position_Y_Amax);

    ui->doubleSpinBox_Position_R_PKp->setValue((double) pid.position_R_PKp);
    ui->doubleSpinBox_Position_R_PKi->setValue((double) pid.position_R_PKi);
    ui->doubleSpinBox_Position_R_PKd->setValue((double) pid.position_R_PKd);
    ui->doubleSpinBox_Position_R_Vmax->setValue((double) pid.position_R_Vmax);
    ui->doubleSpinBox_Position_R_Amax->setValue((double) pid.position_R_Amax);

    ui->doubleSpinBox_Motor_1_VKp->setValue((double) pid.motor_1_VKp);
    ui->doubleSpinBox_Motor_1_VKi->setValue((double) pid.motor_1_VKi);
    ui->doubleSpinBox_Motor_1_VKd->setValue((double) pid.motor_1_VKd);

    ui->doubleSpinBox_Motor_2_VKp->setValue((double) pid.motor_2_VKp);
    ui->doubleSpinBox_Motor_2_VKi->setValue((double) pid.motor_2_VKi);
    ui->doubleSpinBox_Motor_2_VKd->setValue((double) pid.motor_2_VKd);

    ui->doubleSpinBox_Motor_3_VKp->setValue((double) pid.motor_3_VKp);
    ui->doubleSpinBox_Motor_3_VKi->setValue((double) pid.motor_3_VKi);
    ui->doubleSpinBox_Motor_3_VKd->setValue((double) pid.motor_3_VKd);

    ui->doubleSpinBox_Motor_4_VKp->setValue((double) pid.motor_4_VKp);
    ui->doubleSpinBox_Motor_4_VKi->setValue((double) pid.motor_4_VKi);
    ui->doubleSpinBox_Motor_4_VKd->setValue((double) pid.motor_4_VKd);
