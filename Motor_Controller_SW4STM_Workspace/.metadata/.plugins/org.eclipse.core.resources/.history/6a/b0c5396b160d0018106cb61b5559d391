...
void execute_received_command(void){
	...
	case 0x01: //read
		...
		send_float_value(g_parameterManager.m_parameters.m_motor_1_PKp);
		send_float_value(g_parameterManager.m_parameters.m_motor_1_PKi);
		send_float_value(g_parameterManager.m_parameters.m_motor_1_PKd);
		send_float_value(g_parameterManager.m_parameters.m_motor_1_VKp);
		send_float_value(g_parameterManager.m_parameters.m_motor_1_VKi);
		send_float_value(g_parameterManager.m_parameters.m_motor_1_VKd);
	...
	case 0x02: //store
		...
		g_parameterManager.m_parameters.m_motor_1_PKp = receive_float_value(g_messageContent);
		g_parameterManager.m_parameters.m_motor_1_PKi = receive_float_value(g_messageContent + 4);
		g_parameterManager.m_parameters.m_motor_1_PKd = receive_float_value(g_messageContent + 8);

		g_parameterManager.m_parameters.m_motor_1_VKp = receive_float_value(g_messageContent + 12);
		g_parameterManager.m_parameters.m_motor_1_VKi = receive_float_value(g_messageContent + 16);
		g_parameterManager.m_parameters.m_motor_1_VKd = receive_float_value(g_messageContent + 20);

		g_parameterManager.storeParametersInEEPROM();
